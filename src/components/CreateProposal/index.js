...
const CreateProposal = () => {
    ...
    const getState = async () => {
        const timelockBalance = await window.zoraContract
            .methods
    ...
    const createProposal = () => {
        window.govContract
            ...
            .propose(
                ...
                `Release ${details.releaseAmount} ZORA From Timelock`,
            )
                                    ...
                                    <div className="governance-panel__header votes-panel__header">
                                        <div className="votes-panel__header__title-bar">
                                            <h4 style={{ color: "#00d395" }}>
                                                Create Proposal To Release ZORA
                                            </h4>
                                        </div>
                                        ...
                                        <div className="p-4">
                                            <Row style={{ marginBottom: "15px", marginTop: "8px" }}>
                                                ...
                                                <Col sm={8}>
                                                    <input
                                                        ...
                                                        placeholder="Address who will receive ZORA"
                                                        type="text"
                                            ...
                                            <Row style={{ marginBottom: "20px" }}>
                                                ...
                                                <Col sm={8}>
                                                    <input
                                                        className="vote-button mb-3"
                                                        placeholder="Number of ZORA to Release"
                                                        type="number"
                                                        step="0"
                                                        min="0"
                                                        onChange={(e) => setDetails({
