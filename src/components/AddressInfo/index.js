...
const AddressInfo = () => {
    ...
    const [zoraBalance, setZoraBalance] = useState(0);
        ...
        window.zoraContract.methods
            ...
            .on("receipt", () => {
                ...
                setSuccessModal({
                    open: true,
                    msg: "Congratulations 🎉 !! " +
                        "You have successfully delegated your ZORA !!",
                });
            })
            .catch((error) => {
                setDelegating(false);
                                ...
                                <div className="holdings-panel__holdings">
                                    ...
                                    <div className="holdings-panel__holdings__row">
                                        ...
                                        {window.userAddress && address === window.userAddress.toLowerCase() &&
                                            Number(delegateInfo.delegatedVotes) < Number(zoraBalance) ?
                                            <div
